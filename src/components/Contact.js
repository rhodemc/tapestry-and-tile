    ...
    return (
        <section class="bg-white dark:bg-gray-900" id="contact">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Interested in knowing a bit more? Give me a shout!</p>
                <form action="#" class="space-y-8">
                    ...
                    <button type="submit" className="btn bg-accent border-2 border-[#7477FF] text-white px-6 py-3 hover:bg-transparent">Send Message</button>
                </form>
            </div>
        </section>
    )
